...
/**
 getPreviousSearchDataFromLocalStorage: returns a JS Object parsed from the
 ...
 */
export const getPreviousSearchDataFromLocalStorage = (key: string): Record<string, any> => {
    if (!isBrowser) return {}
